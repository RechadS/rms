<?php /* Template Name: Admin developers */ 
get_header(); ?>
    ...
    <div class="container-title container" id="admin-dashboard" style="padding-top:40px;">
        <div class="col-md-3">
            ...
            <div class="admin-menu admin-menu-active"><a href="<?php echo get_home_url();?>/admin-dashboard/admin-developers/" style="color:white;">Développeurs</a></div>
        ...
        <div class="col-md-9">
                ...
                if(isset($_POST['ajoutPM'])){
                    ...
                    isset($_POST['pmPassword']) && $_POST['pmPassword'] != ''){
                        ...
                        if( !is_wp_error($user_id) ) {
                            echo '<p style="color:red;">Le développeur a bien été créé.</p>';
                            $wpdb->query("INSERT INTO wp_usermeta (user_id, meta_key, meta_value) VALUES (".$user_id.", 'rms_role', 'developer')");
                        }
                        else{
            ...
            <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                ...
                $query = "SELECT display_name, ID FROM wp_users INNER JOIN wp_usermeta WHERE wp_users.ID = wp_usermeta.user_id AND meta_key = 'rms_role' AND meta_value = 'designer'";
                $listdevelopers = $wpdb->get_results($query);
                $numpm = 1;
                foreach($listdevelopers as $developer){
                    
                    $query2 = "SELECT project_id FROM wp_postmeta INNER JOIN wp_cpm_user_role WHERE wp_postmeta.post_id = project_id AND user_id = ".$developer->ID." AND meta_key = '_project_active' AND meta_value = 'yes'";
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading" role="tab">
                          <div class="row" style="padding-top:5px;">
                            <div class="col-md-6">
                                <p><a data-toggle="collapse" data-parent="#accordion" href="#collapse'.$numpm.'">'.$developer->display_name.'</a></p>
                ...
                echo "<a href='".get_home_url()."/admin-dashboard/admin-developers/?action=create'>Créer un développeur</a>";  
