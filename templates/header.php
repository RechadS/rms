                ...
                <div class="collapse navbar-collapse navbar-responsive-collapse">
                    <div class="menu-container">
                        ...
                        <ul class="nav navbar-nav right-menu">
                            <li>
                                <a href="#"><img src="<?php echo get_home_url(); ?>/img/frenchflag.png" alt="France" style="vertical-align: baseline;"/>&nbsp; Langue </a>
                            </li>
                            <?php
                        ...
                        <ul class="nav navbar-nav">
                            <li>
                                <a href="<?php echo get_home_url();?>/comment-ca-marche/"><span>Comment ça marche</span></a></li>
                            <li><a href="<?php echo get_home_url();?>/galerie/"><span>Galerie</span></a></li>
                            <li><a href="<?php echo get_home_url();?>/services/"><span>Service</span></a></li>
                        </ul>
</header>
